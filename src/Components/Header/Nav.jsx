...
const Nav = () => {
    ...
    return (
        <div className=''>
            <div className=' py-5 bg-black/30 backdrop-blur-xl shadow-2xl p-5 text-white absolute top-0 left-0 w-full z-50'>
            ...
            {/* Mobile menu */}
            <div className={`md:hidden gap-4 ${open ? "max-h-96 opacity-100" : "max-h-0 opacity-40"} backdrop-blur-sm absolute mt-28 left-2  w-[70%] z-50  transition-all duration-500 overflow-hidden`} >
